<fieldset class="content-group">
	...
	<div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}" >
		...
		<div class="col-lg-10">
			<input type="text"  name="name"  value="{{ $edit_user->name }}" class="form-control" placeholder="Name">
	...
	<div class="form-group {{ $errors->has('role') ? 'has->error' : ''}}">
		...
		<div class="col-lg-10">
			<select name="role" class="form-control">
                <option value="operator">{{ $edit_user->role}}</option>
	...
	<center>
		 @if($edit_user->avatar)
	           <img width="190" height="119" class="img-responsive img-thumbnail" src="{{asset($edit_user->avatar)}}" alt="">
	         @endif
	</center>
